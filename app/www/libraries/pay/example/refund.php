...
<body>  
	<form action="#" method="post">
        ...
        <input type="text" style="width:96%;height:35px;margin-left:2%;" name="transaction_id" value="1007610749201510241311332771"/><br /><br />
        ...
        <input type="text" style="width:96%;height:35px;margin-left:2%;" name="refund_fee" value="1"/><br /><br />
		<div align="center">
