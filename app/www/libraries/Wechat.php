...
class Wechat
{
	...
	public function __construct($params = array())
	{
		...
		$this->logcallback = isset($params['logcallback'])?$params['logcallback']:false;
	}
	...
	*/
	...
	protected function setCache($cachename,$value,$expired){
		...
		//设置缓存$this->session->set_tempdata('item', 'value', 300);
		$setcache=$this->CI->session->set_tempdata($cachename, $value, $expired);
		//return false;
		return $setcache;
	}
	...
	protected function getCache($cachename){
		...
		$cacke_value = $this->CI->session->userdata($cachename);
		return $cacke_value;
		//return false;
	}
	...
	protected function removeCache($cachename){
		...
		$remorecache=$this->CI->session->unset_userdata($cachename);
		//return false;
		return $remorecache;
	}
